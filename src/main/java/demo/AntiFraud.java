...
public class AntiFraud {
    ...
    public static void main(String[] argv) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException
    {
        ...
        final String SECRET_ID = "AKIDWrxoJaNS4SdZInj3oLcfT1KOCm8GjpGS";
        final String SECRET_KEY = "81g5E8qMcdPwEH5dx1pNfhT1JL8fxzmJ";

        Map<String, String> args = new TreeMap<String, String>();

        // 基本字段
        args.put("phoneNumber", "0086-0");
        args.put("imei", "0");
        //
        // 可选字段
        //args.put("idCryptoType", "1");
        //args.put("phoneCryptoType","1");
